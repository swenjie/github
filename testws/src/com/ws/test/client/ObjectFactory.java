 ...
 * element interface generated in the com.ws.test.client package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _TestResponse_QNAME = new QName(
			"http://test.ws.com/", "testResponse");
	private final static QName _Test_QNAME = new QName("http://test.ws.com/",
			"test");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: com.ws.test.client
	 * 
	 */
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://test.ws.com/", name = "testResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://test.ws.com/", name = "test")
