 ...
 * generated in the com.sy.cxf.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHiResponse_QNAME = new QName("http://server.hsy.com/", "sayHiResponse");
    private final static QName _SayHiToUserResponse_QNAME = new QName("http://server.hsy.com/", "sayHiToUserResponse");
    private final static QName _SayHiToUserList_QNAME = new QName("http://server.hsy.com/", "SayHiToUserList");
    private final static QName _SayHiToUser_QNAME = new QName("http://server.hsy.com/", "sayHiToUser");
    private final static QName _SayHiToUserListResponse_QNAME = new QName("http://server.hsy.com/", "SayHiToUserListResponse");
    private final static QName _SayHi_QNAME = new QName("http://server.hsy.com/", "sayHi");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.sy.cxf.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.hsy.com/", name = "sayHiResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.hsy.com/", name = "sayHiToUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.hsy.com/", name = "SayHiToUserList")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.hsy.com/", name = "sayHiToUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.hsy.com/", name = "SayHiToUserListResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.hsy.com/", name = "sayHi")
