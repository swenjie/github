...
public class ObjectFactory {
	...
	private final static QName _TestResponse_QNAME = new QName(
			"http://webservice.test.org/", "testResponse");
	private final static QName _Test_QNAME = new QName(
			"http://webservice.test.org/", "test");
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://webservice.test.org/", name = "testResponse")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://webservice.test.org/", name = "test")
